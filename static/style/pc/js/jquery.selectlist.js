    ...
    SelectList.prototype={
        ...
        renderSelect: function(element){
            var that = this,
                ...
                selectLength = that.getOptionCount($this),
                selectHTML = '<div id="' + selectID + '" class="select-wrapper ' + selectClassName + '"><input type="hidden" name="' + selectName + '" value="' + selectedValue + '" /><i class="icon select-down"><svg viewBox="0 0 1024 1024" width="16" height="16"><path d="M64 320l448 448 448-448z" fill="#707070" p-id="3812"></path></svg></i><input type="button" class="select-button input" value="' + selectedOptionText + '" /><div class="select-list"><ul>',
                selectListHTML = '';
            ...
            if(that.settings.enable){
                $(selectID)
                    .click(function(event){
                        ...
                        $(this).find('.select-down').toggleClass('on');
